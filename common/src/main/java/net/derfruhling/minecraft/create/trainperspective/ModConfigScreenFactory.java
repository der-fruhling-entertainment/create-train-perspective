...
public class ModConfigScreenFactory {
    public static Screen createConfigScreen(Screen parent) {
        ...
        advanced.add(entryBuilder
                .startStrList(
                        new TranslatableComponent("option.create_train_perspective.advanced.blocked_players"),
                        ModConfig.INSTANCE.blockedPlayerUUIDs.stream().map(UUID::toString).toList())
                .setTooltip(new TranslatableComponent("option.create_train_perspective.advanced.blocked_players.tooltip"))
                ...
                .setCellErrorSupplier(s -> {
                    try {
                        ...
                        return Optional.of(new TranslatableComponent("option.create_train_perspective.advanced.blocked_players.error", e.getLocalizedMessage()));
                    }
                })
                .setDefaultValue(new ArrayList<>())
                .build());
        ...
        advanced.add(entryBuilder
                .startBooleanToggle(
                        new TranslatableComponent("option.create_train_perspective.advanced.disable_rotate_when_seated"),
                        ModConfig.INSTANCE.disableRotateWhenSeated
                )
                .setTooltip(new TranslatableComponent("option.create_train_perspective.advanced.disable_rotate_when_seated.tooltip"))
        ...
        debug.add(entryBuilder
                .startBooleanToggle(
                        new TranslatableComponent("option.create_train_perspective.debug.enable_yaw_lock"),
                        ModConfig.INSTANCE.debugEnableYawLock
                )
                .setSaveConsumer(value -> ModConfig.INSTANCE.debugEnableYawLock = value)
                .setTooltip(new TranslatableComponent("option.create_train_perspective.debug.enable_yaw_lock.tooltip"))
                .setDefaultValue(false)
                .build());

        debug.add(entryBuilder
                .startFloatField(
                        new TranslatableComponent("option.create_train_perspective.debug.yaw_lock"),
                        ModConfig.INSTANCE.debugYawLock
                )
                .setSaveConsumer(value -> ModConfig.INSTANCE.debugYawLock = value)
                .setTooltip(new TranslatableComponent("option.create_train_perspective.debug.yaw_lock.tooltip"))
